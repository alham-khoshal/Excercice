var ptrn = new RegExp("^[a-z0-9._-\\s]+$");
...
var ptrn3 = new RegExp("^([0-9]{5,5})+$"); // pour code postale
var ptrn4 = new RegExp("^[a-z0-9._-\\s]+$");
console.log(ptrn4);
// var error = document.getElementById("error_");
var error1 = document.getElementById("error1");
console.log(document.getElementById("error1"));
console.log(error1);
